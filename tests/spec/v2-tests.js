...
describe('/v2/jsdelivr/', function() {
    var address = 'http://localhost:8089/v2/jsdelivr';
        ...
        it('/library', function (done) {
            chai.request(address)
                ...
                .then(function (req) {
                    ...
                    expect(req.body.assets).to.be.instanceof(Array);
...
describe('/v2/cdnjs/', function() {
    var address = 'http://localhost:8089/v2/cdnjs';
...
describe('/v2/google/', function() {
    var address = 'http://localhost:8089/v2/google';
...
describe('/v2/bootstrap/', function() {
    var address = 'http://localhost:8089/v2/bootstrap';
...
describe('/v2/jquery/', function() {
    var address = 'http://localhost:8089/v2/jquery';
